    ...
    <div className="mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center py-2">
      ...
      <main className="mt-12 flex w-full flex-1 flex-col items-center px-4 text-center sm:mt-20">
        <a
          ...
          href="https://github.com/shouryamaanjain"
          target="_blank"
        >
          <span className="text-center">
            Built with ❤️ by {" "}
            <span className="font-medium">Shouryamaan Jain</span>
          </span>
        </a>
        <h1 className="my-6 max-w-3xl text-4xl font-bold text-gray-800 sm:text-6xl">
          Claude <span className="text-blue-600">Artifacts</span>
          <br /> But with <span className="text-blue-600">Llama</span>
        </h1>
              ...
              <div className="relative flex rounded-3xl bg-white shadow-sm">
                <div className="relative flex flex-grow items-stretch focus-within:z-10">
                  <input
                    ...
                    placeholder="Make a calculator app..."
                  />
                </div>
                <button
                  type="submit"
                    ...
                    <Tooltip.Trigger asChild>
                      <button
                        ...
                        onClick={async () => {
                          ...
                          toast.success(
                            `Your app has been published at artifacts.shouryamaanjain.com/share/${appId}`,
                          );
